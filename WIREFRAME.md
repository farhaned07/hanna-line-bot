# Hanna AI Nurse - Complete User Journey Wireframe
...
│  Step 1: Name                            │
│  Step 2: Age                             │
│  Step 3: Diabetes Type                   │
│  Step 4: Monitoring Frequency            │
│  ↓                                       │
│  🎁 Trial Offer (Flex Message)           │
│  [Start Free Trial] [View Paid Plans]    │
└─────────────────────────────────────────┘
```

**Decision Point:**
- **Option A**: User clicks "Start Free Trial" → Go to Phase 2
- **Option B**: User clicks "View Paid Plans" → Go to Payment Flow
...
2. **Health Check-in Logic** - Process user responses properly
3. **Family Notifications** - Group chat integration
4. **Nurse Dashboard** - Web interface for monitoring
5. **Voice Integration** - The ultimate goal

**Does this wireframe capture the complete vision? Any changes needed?**
