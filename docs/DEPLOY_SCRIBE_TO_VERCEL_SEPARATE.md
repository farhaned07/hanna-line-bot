# 🚀 DEPLOY SCRIBE TO VERCEL - SEPARATE PROJECT

## THE PROBLEM

Your root Vercel project deploys `client/` (Nurse Dashboard), NOT `scribe/`.

**Solution:** Create a SEPARATE Vercel project for Scribe.
...
2. Select: `farhaned07/hanna-line-bot`
3. Click **"Import"**
...
2. Click **"Add"**
3. Enter: `scribe.hanna.care` OR `app.hanna.care`
4. Click **"Add"** again
...
## 🎯 WHAT IF I WANT TO USE RAILWAY INSTEAD?

**Railway URL (works RIGHT NOW):**
...
- [ ] Add custom domain `scribe.hanna.care` (optional)
